                    ...
                    {project.coverImage ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (parent) parent.innerHTML = `<div style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;font-size:3rem;font-weight:bold;color:#2D5553;">${project.name?.charAt(0) || '?'}</div>`;
                        }}
                      />
                    ) : (
